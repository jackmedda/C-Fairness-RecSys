...
class IndependentScorePredictor(BaseIndependentPMFWithOptimizer):
    ...
    The independence term is implemented as Bhattacharyya distance
    between scores under the two sensitive features. each target distribution
    is modeled by a normal distribution model.
    ...
    def __init__(self, C, k, eta, a=1e-8, b=1e-24,

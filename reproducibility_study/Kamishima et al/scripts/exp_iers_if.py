...
* 5. A timestamp of rating behavior, optional.
...
-m <METHOD>, --method <METHOD>
    specify algorithm: default=lpmf_mean_match

    * lpmf_mean_match : logistic PMF, mean matching
...
from exp_iers_util import do_task
...
def command_line_parser():
    ...
    ap.add_argument('-m', '--method', type=str, default='lpmf_mean_match',
                    choices=['lpmf_mean_match'])
...
def init_info(opt):
    ...
    if opt.method == 'lpmf_mean_match':
        ...
        info['model']['recommender'] = IndependentItemFinder
        info['model']['options'] = {

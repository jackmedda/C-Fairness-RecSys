...
##last FM 360K
user_num=18000 #user_size
item_num=63086 #item_size
factor_num=64
batch_size=2048*128*1#3600*00

dataset_base_path='../../filtered(20)_sampled(18000 user_id)_lastfm_360K_reproduce_data'
saved_model_path='..'
...
users_features = np.load(dataset_base_path+'/users_features_2num.npy')
...
f_optimizer = torch.optim.Adam(list(model.model_f1.parameters()) + \
                            list(model.model_f2.parameters()),lr=0.005)

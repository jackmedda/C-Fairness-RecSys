import logging
from rerankings.user_oriented_fairness.src.utils.rank_metrics import *
    ...
    for metric in metrics:
        ...
        if metric.startswith('ndcg@'):
            ...
            for uid, group in df_group:
                ...
                ndcgs.append(ndcg_score([group['label'][~np.isnan(group['q*s'])].tolist()], [group['q*s'][~np.isnan(group['q*s'])].tolist()], k=k))

...
* :func:`kamiers.metrics.score_predictor_with_single_categorical_statistics`
* :func:`kamiers.metrics.item_finder_with_single_categorical_statistics`
...
def do_task(opt):
    ...
    if isinstance(info['prediction']['event'], dict):
        ...
        sen = np.concatenate(list(info['prediction']['sensitive'].values()))
    else:
        y_true = info['prediction']['true']
        y_pred = info['prediction']['predicted']
        sen = info['prediction']['sensitive']
    ...
    if info['model']['task_type'] == 'score_predictor':
        ...
        stats = item_finder_and_single_categorical_statistics(
            y_true, y_pred, sen)
    else:
